...
if __name__ == '__main__':
    ...
    for t in ['train', 'test', 'valid']:
        codes = load(f'/home/tyang/paper_recurr/HGNN/data/raw/TL-CodeSum.{t}.json', is_json=True, key='code')
        trees, dropped = get_ast(codes, save_path=f'/home/tyang/paper_recurr/HGNN/data/processed/node_seqs_java.{t}.json')
        node_seqs = get_node_seq(trees, save_path=f'/home/tyang/paper_recurr/HGNN/data/processed/nodes_java.{t}.json')
